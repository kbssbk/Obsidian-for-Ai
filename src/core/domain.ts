...
export type LifeOsTask = { id:string; title:string; projectId:string; due:string; status:LifeOsStatus; researchDone:boolean; draftDone:boolean; priority?:number; estimatedMinutes?:number; path?:string };
...
export type LifeOsPerson = {
  id:string; name:string; nickname?:string; relationship?:string; organization?:string; phone?:string; email?:string; birthday?:string;
  lastContactDate?:string; nextContactDate?:string; contactCadence?:string; interests?:string; giftIdeas?:string; favorite?:boolean; path?:string;
};
