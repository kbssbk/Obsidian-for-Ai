...
export class DashboardView extends ItemView {
  ...
  async render():Promise<void>{
    const root=this.contentEl;root.empty();root.addClass('life-os-view');const today=todayIso();root.createEl('h1',{text:'오늘의 생활 로비'});root.createEl('p',{text:`${today} · 가장 중요한 다음 행동부터 시작합니다.`});
